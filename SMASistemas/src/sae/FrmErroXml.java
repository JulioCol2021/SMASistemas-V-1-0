 ...
 * @author Thiago
 */
public class FrmErroXml extends javax.swing.JDialog {
    ...
    public FrmErroXml(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        funcoes.F_AtribuirClasse(rootPane);
        txtErroXML.setText(variaveis.vmErrosXML);
    ...
    private void initComponents() {
        ...
        txtErroXML = new javax.swing.JTextArea();
        ...
        jLabel29.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/warning.gif"))); // NOI18N
        jLabel29.setText("FATURAMENTO CANCELADO");
        ...
        jLabel30.setText(" Verifique abaixo os erros ao gerar XML da NF-e. Faça as correções necessárias e gere o faturamento novamente.");
        jLabel30.setToolTipText("");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Erro(s) validações NF-e", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 10))); // NOI18N

        txtErroXML.setColumns(20);
        txtErroXML.setEditable(false);
        txtErroXML.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        txtErroXML.setLineWrap(true);
        txtErroXML.setRows(5);
        jScrollPane1.setViewportView(txtErroXML);
    ...
    public static void main(String args[]) {
            ...
            public void run() {
                FrmErroXml dialog = new FrmErroXml(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTextArea txtErroXML;
