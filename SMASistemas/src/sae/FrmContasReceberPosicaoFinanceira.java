 ...
 * @author Thiago
 */
public class FrmContasReceberPosicaoFinanceira extends javax.swing.JDialog {
    ...
    public FrmContasReceberPosicaoFinanceira(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    {
        String vmCampos = "cr_documento,cr_parcela,cr_data_emissao,cr_data_vencimento,cr_data_pagamento,cr_valor_documento";
        String vmCondicao_Consulta = " where not cr_data_pagamento is null";
        if(variaveis.vm_ID != 0)
        {
          vmCondicao_Consulta += " and cr_par_codigo_id =  " + Integer.toString(variaveis.vm_ID) ;
        }
        vmCondicao_Consulta += " order by cr_data_emissao";
        ...
        while (rs.next())
        {
            //dtm.addRow(new Object[]{rs.getString("cr_documento"),rs.getString("cr_parcela"),rs.getString("cr_data_emissao"),rs.getString("cr_data_vencimento"),rs.getString("cr_data_pagamento"),rs.getString("cr_valor_documento")});
          dtm.addRow(new Object[]{rs.getString("cr_documento"),rs.getString("cr_parcela"),funcoes.formataData(rs.getString("cr_data_emissao")),funcoes.formataData(rs.getString("cr_data_vencimento")),funcoes.formataData(rs.getString("cr_data_pagamento")),funcoes.formataMoeda(rs.getString("cr_valor_documento"),"BD")});
        }
        rs.close();
        ...
        String vmCampos1 = " sum(cr_valor_documento) as total ";
        String vmCondicao_Consulta1 = " where not cr_data_pagamento is null " ;
        if(variaveis.vm_ID != 0)
        {
            vmCondicao_Consulta1 += " and cr_par_codigo_id =  " + Integer.toString(variaveis.vm_ID);
        }


        try
        {
        rs = AcessoDados.Selecao("Contas_receber", vmCampos1, vmCondicao_Consulta1);
        rs.next();
     ...
     public void MontaGridAVencer()
    {
        ...
        String vmCampos = "cr_documento,cr_parcela,cr_data_emissao,cr_data_vencimento,cr_data_pagamento,cr_valor_documento";
        String vmCondicao_Consulta = " where cr_data_pagamento is null";
        if(variaveis.vm_ID != 0)
        {
          vmCondicao_Consulta += " and cr_par_codigo_id =  " + Integer.toString(variaveis.vm_ID) ;
        }
        vmCondicao_Consulta += " and cr_data_vencimento >= current_date order by cr_data_vencimento";
        ...
        {
            //dtm.addRow(new Object[]{rs.getString("cr_documento"),rs.getString("cr_parcela"),rs.getString("cr_data_emissao"),rs.getString("cr_data_vencimento"),rs.getString("cr_data_pagamento"),rs.getString("cr_valor_documento")});
            dtm.addRow(new Object[]{rs.getString("cr_documento"),rs.getString("cr_parcela"),funcoes.formataData(rs.getString("cr_data_emissao")),funcoes.formataData(rs.getString("cr_data_vencimento")),rs.getString("cr_data_pagamento"),funcoes.formataMoeda(rs.getString("cr_valor_documento"),"BD")});
        ...
        String vmCampos1 = " sum(cr_valor_documento) as total ";
        String vmCondicao_Consulta1 = " where cr_data_pagamento is null and cr_data_vencimento >= current_date";
        if(variaveis.vm_ID != 0)
        {
            vmCondicao_Consulta1 += " and cr_par_codigo_id =  " + Integer.toString(variaveis.vm_ID);
        }
      ...
      public void MontaGridAVencidos()
    {
        ...
        {
            //dtm.addRow(new Object[]{rs.getString("cr_documento"),rs.getString("cr_parcela"),rs.getString("cr_data_emissao"),rs.getString("cr_data_vencimento"),rs.getString("cr_data_pagamento"),rs.getString("cr_valor_documento")});
            // dtm.addRow(new Object[]{rs.getString("cr_documento"),rs.getString("cr_parcela"),funcoes.formataData(rs.getString("cr_data_emissao")),funcoes.formataData(rs.getString("cr_data_vencimento")),funcoes.formataData(rs.getString("cr_data_pagamento")),funcoes.formataMoeda(rs.getString("cr_valor_documento").replace(".", ","))});
            dtm.addRow(new Object[]{rs.getString("cr_documento"),rs.getString("cr_parcela"),funcoes.formataData(rs.getString("cr_data_emissao")),funcoes.formataData(rs.getString("cr_data_vencimento")),rs.getString("cr_data_pagamento"),funcoes.formataMoeda(rs.getString("cr_valor_documento"),"BD")});
