...
/*
 * FrmRamodeAtividade.java
 *
 * Created on 17/01/2010, 19:07:53
 */
 ...
 * @author Thiago
 */
public class FrmRamodeAtividade extends javax.swing.JDialog {
    ...
    /** Creates new form FrmRamodeAtividade */
    public FrmRamodeAtividade(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        txtDescricao.setName("ramo_descricao"); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lbID)
                    .addComponent(txtDescricao, javax.swing.GroupLayout.DEFAULT_SIZE, 392, Short.MAX_VALUE))
                .addContainerGap())
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        funcoes.GravarDados(lbID.getText(), rootPane, "ramo_de_atividade", "ramo_codigo_id",true);
        lbStatus.setText(" Registro");
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        {
        funcoes.ExcluirDados(lbID.getText(), rootPane, "ramo_de_atividade", "ramo_codigo_id");
        btnNovo.requestFocus();
        }
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
       ...
       {
          String vmCampos = "*";
          String vmCondicao_Consulta = " WHERE ramo_codigo_id = " + lbID.getText();
          try
        {
        rs = AcessoDados.Selecao("ramo_de_atividade", vmCampos, vmCondicao_Consulta);
        rs.next();
        txtDescricao.setText(rs.getString("ramo_descricao"));
        rs.close();
          }catch (Exception e) {
           e.printStackTrace();
        }
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        ...
        String vmCampos = "*";
        String vmCondicao_Consulta = "order by ramo_codigo_id ";
        try
        {
        rs = AcessoDados.Selecao("ramo_de_atividade", vmCampos, vmCondicao_Consulta);
         }catch (Exception e) {
        ...
        try
        {
          ...
          JasperReport jr = (JasperReport) JRLoader.loadObject(getClass().getClassLoader().getResource("Relatorios/RelRamoAtividade.jasper"));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmRamodeAtividade dialog = new FrmRamodeAtividade(new javax.swing.JFrame(), true);
