...
/*
 * FrmFormaPagamento.java
 *
 * Created on 19/01/2010, 15:43:54
 */
 ...
 * @author Thiago
 */
public class FrmFormaPagamento extends javax.swing.JDialog {
    ...
    public FrmFormaPagamento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        txtDescricao.setName("fpgto_descricao"); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lbID)
                    .addComponent(txtDescricao, javax.swing.GroupLayout.DEFAULT_SIZE, 382, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        funcoes.GravarDados(lbID.getText(), rootPane, "forma_de_pagamento", "fpgto_codigo_id",true);
        lbStatus.setText(" Registro");
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        {
        funcoes.ExcluirDados(lbID.getText(), rootPane, "forma_de_pagamento", "fpgto_codigo_id");
        btnNovo.requestFocus();
        }
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
       ...
       {
          String vmCampos = "*";
          String vmCondicao_Consulta = " WHERE fpgto_codigo_id = " + lbID.getText();
          try
        {
        rs = AcessoDados.Selecao("forma_de_pagamento", vmCampos, vmCondicao_Consulta);
        rs.next();
        txtDescricao.setText(rs.getString("fpgto_descricao"));
        rs.close();
          }catch (Exception e) {
           e.printStackTrace();
        }
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        ...
        {
        String vmCampos = "*";
        String vmCondicao_Consulta = "order by fpgto_codigo_id ";
        try
        {
        rs = AcessoDados.Selecao("forma_de_pagamento", vmCampos, vmCondicao_Consulta);
         }catch (Exception e) {
        ...
        try
        {
         ...
         JasperReport jr = (JasperReport) JRLoader.loadObject(getClass().getClassLoader().getResource("Relatorios/RelFormaPagamento.jasper"));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmFormaPagamento dialog = new FrmFormaPagamento(new javax.swing.JFrame(), true);
