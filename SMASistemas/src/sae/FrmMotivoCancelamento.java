 ...
 * @author Thiago
 */
public class FrmMotivoCancelamento extends javax.swing.JDialog {
    ...
    public FrmMotivoCancelamento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Motivo de Cancelamento");
        setResizable(false);
        ...
        jLabel30.setText("Informe o motivo do cancelamento da NF-e. Não use acentuação no texto.");
        jLabel30.setToolTipText("");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Motivo Cancelamento", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 10))); // NOI18N

        txtCancelamento.setColumns(80);
    ...
    public static void main(String args[]) {
            ...
            public void run() {
                FrmMotivoCancelamento dialog = new FrmMotivoCancelamento(new javax.swing.JFrame(), true);
