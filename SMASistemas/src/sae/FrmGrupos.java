 ...
 * FrmGrupos.java
 *
 * Created on 21/01/2010, 15:10:22
 */
...
public class FrmGrupos extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnPesquisar.setMaximumSize(new java.awt.Dimension(85, 25));
        btnPesquisar.setMinimumSize(new java.awt.Dimension(85, 25));
        ...
        txtDescricao.setName("grup_descricao"); // NOI18N

        jLabel3.setFont(new java.awt.Font("Dialog", 0, 11)); // NOI18N
        jLabel3.setText("Tipo:");
        jLabel3.setToolTipText("");

        ddlTipo.setFont(new java.awt.Font("Dialog", 0, 11)); // NOI18N
        ddlTipo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "CLIENTE", "FORNECEDOR", "PRODUTO" }));
        ddlTipo.setToolTipText("");
        ddlTipo.setEnabled(false);
        ddlTipo.setName("grup_tipo"); // NOI18N
        ddlTipo.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                ddlTipoFocusLost(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(10, 10, 10)
                        .addComponent(ddlTipo, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(18, 18, 18)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(ddlTipo, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel3))
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        funcoes.GravarDados(lbID.getText(), rootPane, "grupos", "grup_codigo_id",true);
        lbStatus.setText(" Registro");
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        {
        funcoes.ExcluirDados(lbID.getText(), rootPane, "grupos", "grup_codigo_id");
        btnNovo.requestFocus();
        }
    }//GEN-LAST:event_btnExcluirActionPerformed

    private void ddlTipoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_ddlTipoFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_ddlTipoFocusLost
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
       ...
       {
          String vmCampos = "*";
          String vmCondicao_Consulta = " WHERE grup_codigo_id = " + lbID.getText();
        try
        {
        rs = AcessoDados.Selecao("grupos", vmCampos, vmCondicao_Consulta);
        rs.next();
        txtDescricao.setText(rs.getString("grup_descricao"));
        ddlTipo.setSelectedItem(rs.getString("grup_tipo"));
        rs.close();
          }catch (Exception e) {
           e.printStackTrace();
        }
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        ...
        {
        String vmCampos = "*";
        String vmCondicao_Consulta = "order by grup_codigo_id ";
        try
        {
        rs = AcessoDados.Selecao("Grupos", vmCampos, vmCondicao_Consulta);
         }catch (Exception e) {
        ...
        try
        {
          JasperReport jr = (JasperReport) JRLoader.loadObject(getClass().getClassLoader().getResource("Relatorios/RelGrupo.jasper"));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmGrupos dialog = new FrmGrupos(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JComboBox ddlTipo;
