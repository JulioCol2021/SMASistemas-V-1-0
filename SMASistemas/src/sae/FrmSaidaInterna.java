 ...
 * @author Thiago
 */
public class FrmSaidaInterna extends javax.swing.JDialog {
    ...
    public FrmSaidaInterna(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void MontaGrid()
    {
        ...
        String vmCondicao_Consulta = " LEFT join produtos on (prod_codigo_id = item_prod_codigo_id) " +
                                     ...
                                     " where item_sai_codigo_id = " + lbID.getText() + " order by item_codigo_id";
        try
        {
        DefaultTableModel tableModel =(DefaultTableModel) grDados.getModel();
        tableModel.setNumRows(0);
        rs = AcessoDados.Selecao("Item_Saida_interna", vmCampos, vmCondicao_Consulta);
        MontaTituloGrid();
 ...
 public void MontaGridPesquisaDescricao()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtFornecedor, javax.swing.GroupLayout.DEFAULT_SIZE, 56, Short.MAX_VALUE)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnPesquisaFornecedor, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtNomeFornecedor, javax.swing.GroupLayout.DEFAULT_SIZE, 475, Short.MAX_VALUE)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtControleInterno, 0, 0, Short.MAX_VALUE))))
                .addContainerGap())
            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    public int retornaID() {
        String vmCampos = " max(sai_codigo_id)as ID ";
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
       ...
       {
           JOptionPane.showMessageDialog(null,"Nenhum fornecedor foi informado");
       ...
       if (variaveis.status == "I")
        {
            ...
            int confirmar = JOptionPane.showOptionDialog(null, "Confirma SAÍDA INTERNA de estoque?", " Mensagem...",JOptionPane.DEFAULT_OPTION, JOptionPane. QUESTION_MESSAGE,null,options, options[0]);
            if(confirmar==1){
                txtEmpresa.requestFocus();
                return;
               }
            try
            {
               String vmCampos = "sai_emp_codigo_id, sai_par_codigo_id, sai_data, sai_controle_interno, sai_observacao, sai_usuario";
            ...
            AcessoDados.Inserir("Saida_Interna", vmCampos, vmParametros);
            int VMCodigoMaster = retornaID();
            //Incluindo Item Pedido
            vmCampos = "";
            vmCampos += "  item_sai_codigo_id,  ";
            ...
            for(int i = 0; i <= grDados.getRowCount() - 1; i++)
            {
              ...
              AcessoDados.Inserir("item_Saida_interna", vmCampos, vmParametros);
    ...
    private void btnPesquisaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisaActionPerformed
        ...
        {
         variaveis.xColuna1 = "sai_codigo_id";
         variaveis.xColuna2 = "par_nome_razao_social";
         variaveis.xColuna3 = "to_char(sai_data, 'DD/MM/YYYY')";
         variaveis.xColuna4 = "sai_controle_interno";
         variaveis.xColuna5 = "''";
         variaveis.xColuna6 = "''";
         variaveis.xColuna7 = "''";
         variaveis.xColuna8 = "''";
         ...
         variaveis.xColunaStart = "sai_controle_interno";
         variaveis.xColunaNomeStart = "Controle Interno";
         variaveis.xTabela = "saida_interna";
         variaveis.xSql = " INNER JOIN PARCEIROS ON (PAR_CODIGO_ID = sai_par_codigo_id) "; 
         ...
         md.setTitle("Pesquisa Saída Interna - ENTER ou DUPLO CLICK no registro retorna dados.");
       ...
       {
          String vmCampos = "*";
          String vmCondicao_Consulta = " where sai_codigo_id = " + lbID.getText();
          try
        {
        rs = AcessoDados.Selecao("Saida_interna", vmCampos, vmCondicao_Consulta);
        rs.next();
        txtEmpresa.setText(rs.getString("sai_emp_codigo_id"));
        txtFornecedor.setText(rs.getString("sai_par_codigo_id"));
        Date data = rs.getDate("sai_data");
        SimpleDateFormat formatarDate = new SimpleDateFormat("dd/MM/yyyy");
        txtData.setText(formatarDate.format(data));
        txtControleInterno.setText(rs.getString("sai_controle_interno"));
        txtObservacao.setText(rs.getString("sai_observacao"));
