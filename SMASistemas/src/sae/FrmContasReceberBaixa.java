 ...
 * @author Thiago
 */
public class FrmContasReceberBaixa extends javax.swing.JDialog {
    ...
    public FrmContasReceberBaixa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Baixa - Contas a Receber");
        setResizable(false);
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtFavorecido, javax.swing.GroupLayout.DEFAULT_SIZE, 355, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        // TODO add your handling code here:
       // vmData = txtDataPagamento.getText();
       if (txtDataPagamento.getText().equals("  /  /    "))
        ...
        vmData = "cr_data_pagamento = '"  + txtDataPagamento.getText() + "',";
        ...
        if(Pendente == 0)
        {
           try
            ...
            String vmCampos2 = " rcr_cr_codigo_id, " +
                               " rcr_data_recebimento, " +
                               " rcr_usuario, " +
                               " rcr_valor_recebido, rcr_acrescimo, rcr_desconto";
            ...
            AcessoDados.Inserir("recebimento_contas_receber", vmCampos2, vmParametros);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        //lbValor.setText(funcoes.formataMoeda(rs.getString("cr_valor_documento"),"BD"));
        lbValor.setText(funcoes.formataMoeda(Double.toString(variaveis.vm_valor_pendente),"BD"));
        txtAcrescimo.setText(funcoes.formataMoeda(rs.getString("cr_acrescimo"),"BD"));
        txtDesconto.setText(funcoes.formataMoeda(rs.getString("cr_desconto"),"BD"));
        txtValorPago.setText(funcoes.formataMoeda(rs.getString("cr_valor_pago"),"BD"));
        txtFavorecido.setText(rs.getString("cr_favorecido"));
        txtObservacaoBaixa.setText(rs.getString("cr_observacao_baixa"));
        Date data = rs.getDate("cr_data_pagamento");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmContasReceberBaixa dialog = new FrmContasReceberBaixa(new javax.swing.JFrame(), true);
