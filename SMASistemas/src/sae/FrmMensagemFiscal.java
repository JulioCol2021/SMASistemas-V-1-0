...
/*
 * FrmMensagemFiscal.java
 *
 * Created on 18/01/2010, 20:41:33
 */
 ...
 */
public class FrmMensagemFiscal extends javax.swing.JDialog {
    ...
    /** Creates new form FrmMensagemFiscal */
    public FrmMensagemFiscal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        txtDescricao.setName("msg_descricao"); // NOI18N
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        funcoes.GravarDados(lbID.getText(), rootPane, "mensagem_fiscal", "msg_codigo_id",true);
        lbStatus.setText(" Registro");
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        {
        funcoes.ExcluirDados(lbID.getText(), rootPane, "mensagem_fiscal", "msg_codigo_id");
        btnNovo.requestFocus();
        }
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
       ...
       {
          String vmCampos = "*";
          String vmCondicao_Consulta = " WHERE msg_codigo_id = " + lbID.getText();
          try
        {
        rs = AcessoDados.Selecao("Mensagem_fiscal", vmCampos, vmCondicao_Consulta);
        rs.next();
        txtDescricao.setText(rs.getString("msg_descricao"));
        rs.close();
          }catch (Exception e) {
           e.printStackTrace();
        }
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        ...
        {
        String vmCampos = "*";
        String vmCondicao_Consulta = "order by msg_codigo_id ";
        try
        {
        rs = AcessoDados.Selecao("mensagem_fiscal", vmCampos, vmCondicao_Consulta);
         }catch (Exception e) {
        ...
        try
        {
          JasperReport jr = (JasperReport) JRLoader.loadObject(getClass().getClassLoader().getResource("Relatorios/RelMensagemFiscal.jasper"));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmMensagemFiscal dialog = new FrmMensagemFiscal(new javax.swing.JFrame(), true);
