...
public class FpesqCidade extends javax.swing.JDialog {
    ...
    public void MontaTituloColunaGrid()
    {
        grDados.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {},
            new String [] {"Código ","Código UF","UF","Código Município","Município",""
        ...
        grDados.getColumnModel().getColumn(1).setPreferredWidth(30);
        grDados.getColumnModel().getColumn(2).setPreferredWidth(10);
        grDados.getColumnModel().getColumn(3).setPreferredWidth(70);
        grDados.getColumnModel().getColumn(4).setPreferredWidth(280);
    ...
    public void MontaGridCodigo()
    {
        ...
        if (!txtCodigo.getText().equals(""))
            vmCondicao_Consulta = " where cid_codigo_id = " + txtCodigo.getText() + " order by cid_codigo_id";
        else
            vmCondicao_Consulta = " order by cid_codigo_id";
        ...
        while (rs.next())
        {
            dtm.addRow(new Object[]{rs.getString("cid_codigo_id"),rs.getString("cid_codigo_uf"),rs.getString("cid_uf"),rs.getString("cid_codigo_municipio"),rs.getString("cid_municipio"),""});
        }
        rs.close();
    ...
    public void MontaGridDescricao()
    {
        ...
        if (!txtDescricao.getText().equals(""))
            vmCondicao_Consulta = " where cid_municipio like '" + txtDescricao.getText() + "%' order by cid_municipio";
        else
            vmCondicao_Consulta = " order by cid_municipio";
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtDescricao, javax.swing.GroupLayout.DEFAULT_SIZE, 560, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
