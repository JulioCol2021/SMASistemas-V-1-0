 ...
 * @author Thiago
 */
public class FpesqUsuario extends javax.swing.JDialog {
    ...
    public FpesqUsuario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void MontaGridCodigo()
    {
        ...
        if (variaveis.nome_usuario.equals("MASTER"))
        {
        if (!txtCodigo.getText().equals(""))
            vmCondicao_Consulta = " WHERE usu_codigo_id = " + txtCodigo.getText() + " ORDER BY usu_codigo_id";
        else
            vmCondicao_Consulta = " ORDER BY usu_codigo_id";
        }else
        {
            vmCondicao_Consulta = " WHERE usu_nome = '" + variaveis.nome_usuario + "' ORDER BY usu_codigo_id";
        }
        ...
        while (rs.next())
        {
            dtm.addRow(new Object[]{rs.getString("usu_codigo_id"),rs.getString("usu_nome"),""});
        }
        rs.close();
    ...
    public void MontaGridDescricao()
    {
        ...
        if (!txtDescricao.getText().equals(""))
            vmCondicao_Consulta = " where usu_nome like '" + txtDescricao.getText() + "%' order by usu_nome";
        else
            vmCondicao_Consulta = " order by usu_nome";
        }else
        {
            vmCondicao_Consulta = " where usu_nome ='" + variaveis.nome_usuario + "' order by usu_nome";
        }
        try
        {
        rs = AcessoDados.Selecao("usuarios", vmCampos, vmCondicao_Consulta);
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtDescricao, javax.swing.GroupLayout.DEFAULT_SIZE, 384, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jTabbedPane1.addTab("Nome", jPanel3);
