 ...
 * @author thiago
 */
public class FpesqEntradaNota extends javax.swing.JDialog {
    ...
    public FpesqEntradaNota(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void MontaTituloColunaGrid()
    {
        grDados.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {},
            new String [] {"ID ","Nota", "Entrada", "Emissão", "Parceiro",""
        ...
        grDados.getColumnModel().getColumn(1).setPreferredWidth(80);
        grDados.getColumnModel().getColumn(2).setPreferredWidth(90);
        grDados.getColumnModel().getColumn(3).setPreferredWidth(90);
        grDados.getColumnModel().getColumn(4).setPreferredWidth(400);
        grDados.getColumnModel().getColumn(5).setPreferredWidth(20);
    ...
    public void MontaGridNumNotaFiscal()
    {
        ...
        String vmCampos = "ENT_CODIGO_ID, ENT_NUMERO_NOTA, to_char(ENT_DATA_ENTRADA, 'DD/MM/YYYY') AS ENT_DATA_ENTRADA, to_char(ENT_DATA_EMISSAO, 'DD/MM/YYYY') AS ENT_DATA_EMISSAO, PAR_NOME_RAZAO_SOCIAL";
        String vmCondicao_Consulta = "";

        if (!txtNotaFical.getText().equals(""))
            vmCondicao_Consulta = " INNER JOIN PARCEIROS ON (ENT_PAR_CODIGO_ID = PAR_CODIGO_ID) WHERE ENT_NUMERO_NOTA = " + txtNotaFical.getText() + " ORDER BY ENT_NUMERO_NOTA DESC";
        else
            vmCondicao_Consulta = " INNER JOIN PARCEIROS ON (ENT_PAR_CODIGO_ID = PAR_CODIGO_ID) ORDER BY ENT_NUMERO_NOTA DESC";
        ...
        try
        {
            ...
            while (rs.next())
            {
                dtm.addRow(new Object[]{rs.getString("ENT_CODIGO_ID"),rs.getString("ENT_NUMERO_NOTA"),rs.getString("ENT_DATA_ENTRADA"),rs.getString("ENT_DATA_EMISSAO"),rs.getString("PAR_NOME_RAZAO_SOCIAL"),""});
            }
            rs.close();
    ...
    public void MontaGridDataEmissao()
    {
        ...
        if (!txtDataEntrada.getText().equals("  /  /    "))
            vmCondicao_Consulta = " INNER JOIN PARCEIROS ON (ENT_PAR_CODIGO_ID = PAR_CODIGO_ID) WHERE ENT_DATA_ENTRADA = '" + txtDataEntrada.getText() + "' ORDER BY ENT_DATA_ENTRADA DESC";
        else
            vmCondicao_Consulta = " INNER JOIN PARCEIROS ON (ENT_PAR_CODIGO_ID = PAR_CODIGO_ID) ORDER BY ENT_DATA_ENTRADA DESC";
    ...
    public void MontaGridDataFaturamento()
    {
        ...
        if (!txtDataEmissao.getText().equals("  /  /    "))
            vmCondicao_Consulta = " INNER JOIN PARCEIROS ON (ENT_PAR_CODIGO_ID = PAR_CODIGO_ID) WHERE ENT_DATA_EMISSAO = '" + txtDataEmissao.getText() + "' ORDER BY ENT_DATA_EMISSAO DESC";
        else
            vmCondicao_Consulta = " INNER JOIN PARCEIROS ON (ENT_PAR_CODIGO_ID = PAR_CODIGO_ID) ORDER BY ENT_DATA_EMISSAO DESC";
    ...
    public void MontaGridParceiro()
    {
        ...
        if (!txtParceiro.getText().equals(""))
            vmCondicao_Consulta = " INNER JOIN PARCEIROS ON (ENT_PAR_CODIGO_ID = PAR_CODIGO_ID) WHERE PAR_NOME_RAZAO_SOCIAL LIKE '" + txtParceiro.getText() + "%' ORDER BY PAR_NOME_RAZAO_SOCIAL";
        else
            vmCondicao_Consulta = " INNER JOIN PARCEIROS ON (ENT_PAR_CODIGO_ID = PAR_CODIGO_ID) ORDER BY PAR_NOME_RAZAO_SOCIAL";
    ...
    private void initComponents() {
        ...
        setTitle("Pesquisa Enrtrada de Notas");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtDataEntrada, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jTabbedPane1.addTab("Data Entrada", jPanel4);
        ...
        jTabbedPane1.addTab("Data Emissão", jPanel5);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FpesqEntradaNota dialog = new FpesqEntradaNota(new javax.swing.JFrame(), true);
