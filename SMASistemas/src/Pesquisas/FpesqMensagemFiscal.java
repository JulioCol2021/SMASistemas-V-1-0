 ...
 * @author Thiago
 */
public class FpesqMensagemFiscal extends javax.swing.JDialog {
    ...
    public FpesqMensagemFiscal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void MontaGridCodigo()
    {
        ...
        if (!txtCodigo.getText().equals(""))
            vmCondicao_Consulta = " where msg_codigo_id = " + txtCodigo.getText() + " order by msg_codigo_id";
        else
            vmCondicao_Consulta = " order by msg_codigo_id";
        ...
        while (rs.next())
        {
            dtm.addRow(new Object[]{rs.getString("MSG_CODIGO_ID"),rs.getString("MSG_DESCRICAO"),""});
        }
        rs.close();
    ...
    public void MontaGridDescricao()
    {
        ...
        if (!txtDescricao.getText().equals(""))
            vmCondicao_Consulta = " where msg_descricao like '" + txtDescricao.getText() + "%' order by msg_codigo_id";
        else
            vmCondicao_Consulta = " order by msg_codigo_id";
    ...
    private void initComponents() {
        ...
        setTitle("Pesquisa Mensagem Fiscal");
        setResizable(false);
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtDescricao, javax.swing.GroupLayout.DEFAULT_SIZE, 515, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
