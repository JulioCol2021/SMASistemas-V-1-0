 ...
 * @author Thiago
 */
public class FpesqEmpresa extends javax.swing.JDialog {
    ...
    public FpesqEmpresa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void MontaGridCodigo()
    {
        ...
        if (!txtCodigo.getText().equals(""))
            vmCondicao_Consulta = " where emp_codigo_id = " + txtCodigo.getText() + " order by emp_codigo_id";
        else
            vmCondicao_Consulta = " order by emp_codigo_id";
        ...
        while (rs.next())
        {
            dtm.addRow(new Object[]{rs.getString("emp_codigo_id"),rs.getString("emp_nome"),""});
        }
        rs.close();
    ...
    public void MontaGridDescricao()
    {
        ...
        if (!txtDescricao.getText().equals(""))
            vmCondicao_Consulta = " where emp_nome like '" + txtDescricao.getText() + "%' order by emp_codigo_id";
        else
            vmCondicao_Consulta = " order by emp_codigo_id";
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtDescricao, javax.swing.GroupLayout.DEFAULT_SIZE, 542, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
