 ...
 * @author Thiago
 */
public class FpesqFuncionario extends javax.swing.JDialog {
    ...
    public FpesqFuncionario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void MontaGridCodigo()
    {
        ...
        if (!txtCodigo.getText().equals(""))
            vmCondicao_Consulta = " where func_nome like '" + txtCodigo.getText() + "%' order by func_codigo_id";
        else
            vmCondicao_Consulta = " order by func_codigo_id";
        ...
        while (rs.next())
        {
            dtm.addRow(new Object[]{rs.getString("func_codigo_id"),rs.getString("func_nome"),rs.getString("func_cargo"),""});
        }
        rs.close();
    ...
    private void initComponents() {
        ...
        setTitle("Pesquisa Funcionarios");
        setResizable(false);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtCodigo, javax.swing.GroupLayout.DEFAULT_SIZE, 548, Short.MAX_VALUE)
