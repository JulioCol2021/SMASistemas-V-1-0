 ...
 * @author Thiago
 */
public class FpesqAlmoxarifado extends javax.swing.JDialog {
    ...
    public FpesqAlmoxarifado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void MontaGridCodigo()
    {
        ...
        if (!txtCodigo.getText().equals(""))
            vmCondicao_Consulta = " where almox_codigo_id = " + txtCodigo.getText() + " order by almox_codigo_id";
        else
            vmCondicao_Consulta = " order by almox_codigo_id";
        ...
        while (rs.next())
        {
            dtm.addRow(new Object[]{rs.getString("almox_codigo_id"),rs.getString("almox_descricao"),""});
        }
        rs.close();
    ...
    public void MontaGridDescricao()
    {
        ...
        if (!txtDescricao.getText().equals(""))
            vmCondicao_Consulta = " where almox_descricao like '" + txtDescricao.getText() + "%' order by almox_codigo_id";
        else
            vmCondicao_Consulta = " order by almox_codigo_id";
    ...
    private void initComponents() {
        ...
        setTitle("Pesquisa Almoxarifados");
        setResizable(false);
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jToolBar1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 465, Short.MAX_VALUE)
        );
