 ...
 */
public class FpesqCfop extends javax.swing.JDialog {
    ...
    public FpesqCfop(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void MontaGridCodigo()
    {
        ...
        if (!txtCodigo.getText().equals(""))
            vmCondicao_Consulta = " where cfop_cfop like'" + txtCodigo.getText() + "%' order by cfop_cfop";
        else
            vmCondicao_Consulta = " order by cfop_cfop";
        ...
        while (rs.next())
        {
            dtm.addRow(new Object[]{rs.getString("cfop_cfop"),rs.getString("cfop_descricao"),""});
        }
        rs.close();
    ...
    public void MontaGridDescricao()
    {
        ...
        if (!txtDescricao.getText().equals(""))
            vmCondicao_Consulta = " where cfop_descricao like '" + txtDescricao.getText() + "%' order by cfop_codigo_id";
        else
            vmCondicao_Consulta = " order by cfop_codigo_id";
    ...
    private void initComponents() {
        ...
        btnPesquisaDescricao.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
