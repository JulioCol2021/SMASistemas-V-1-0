 ...
 * @author Thiago
 */
public class FpesqFormaPagamento extends javax.swing.JDialog {
    ...
    public FpesqFormaPagamento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void MontaGridCodigo()
    {
        ...
        if (!txtCodigo.getText().equals(""))
            vmCondicao_Consulta = " where fpgto_codigo_id = " + txtCodigo.getText() + " order by fpgto_codigo_id";
        else
            vmCondicao_Consulta = " order by fpgto_codigo_id";
        ...
        while (rs.next())
        {
            dtm.addRow(new Object[]{rs.getString("fpgto_codigo_id"),rs.getString("fpgto_descricao"),""});
        }
        rs.close();
    ...
    public void MontaGridDescricao()
    {
        ...
        if (!txtDescricao.getText().equals(""))
            vmCondicao_Consulta = " where fpgto_descricao like '" + txtDescricao.getText() + "%' order by fpgto_codigo_id";
        else
            vmCondicao_Consulta = " order by fpgto_descricao";
    ...
    private void initComponents() {
        ...
        setTitle("Pesquisa Formas de Pagamentos");
        setResizable(false);
