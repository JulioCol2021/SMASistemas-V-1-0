 ...
 * @author Thiago
 */
public class FpesqRamoAtividade extends javax.swing.JDialog {
    ...
    public FpesqRamoAtividade(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void MontaGridCodigo()
    {
        ...
        if (!txtCodigo.getText().equals(""))
            vmCondicao_Consulta = " WHERE RAMO_CODIGO_ID = " + txtCodigo.getText() + " ORDER BY RAMO_CODIGO_ID";
        else
            vmCondicao_Consulta = " ORDER BY RAMO_CODIGO_ID";
        ...
        while (rs.next())
        {
            dtm.addRow(new Object[]{rs.getString("RAMO_CODIGO_ID"),rs.getString("RAMO_DESCRICAO"),""});
        }
        rs.close();
    ...
    public void MontaGridDescricao()
    {
        ...
        if (!txtDescricao.getText().equals(""))
            vmCondicao_Consulta = " where RAMO_DESCRICAO like '" + txtDescricao.getText() + "%' order by RAMO_CODIGO_ID";
        else
            vmCondicao_Consulta = " order by RAMO_CODIGO_ID";
    ...
    private void initComponents() {
        ...
        setTitle("  (FpesqRamoAtividade) - Pesquisa Ramo de Atividade");
        setResizable(false);
