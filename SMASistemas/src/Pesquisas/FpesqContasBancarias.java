 ...
 * @author Thiago
 */
public class FpesqContasBancarias extends javax.swing.JDialog {
    ...
    public FpesqContasBancarias(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void MontaGridCodigo()
    {
        ...
        if (!txtCodigo.getText().equals(""))
            vmCondicao_Consulta = " where banc_codigo_id = " + txtCodigo.getText() + " order by banc_codigo_id";
        else
            vmCondicao_Consulta = " order by banc_codigo_id";
        ...
        while (rs.next())
        {
            dtm.addRow(new Object[]{rs.getString("banc_codigo_id"),rs.getString("banc_nome_banco"),""});
        }
        rs.close();
    ...
    public void MontaGridDescricao()
    {
        ...
        if (!txtDescricao.getText().equals(""))
            vmCondicao_Consulta = " where banc_nome_banco like '" + txtDescricao.getText() + "%' order by banc_codigo_id";
        else
            vmCondicao_Consulta = " order by banc_codigo_id";
    ...
    private void initComponents() {
        ...
        setTitle("Pesquisa Contas Bancarias");
        setResizable(false);
