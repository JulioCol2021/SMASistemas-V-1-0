 ...
 * @author Thiago
 */
public class FpesqCentroCusto extends javax.swing.JDialog {
    ...
    public FpesqCentroCusto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void MontaGridCodigo()
    {
        ...
        if (!txtCodigo.getText().equals(""))
            vmCondicao_Consulta = " where custo_codigo_id = " + txtCodigo.getText() + " order by custo_codigo_id";
        else
            vmCondicao_Consulta = " order by custo_codigo_id";
        ...
        while (rs.next())
        {
            dtm.addRow(new Object[]{rs.getString("custo_codigo_id"),rs.getString("custo_descricao")});
        }
        rs.close();
        grDados.getColumnModel().getColumn(0).setPreferredWidth(5);
        grDados.getColumnModel().getColumn(1).setPreferredWidth(350);
    ...
    public void MontaGridDescricao()
    {
        ...
        if (!txtDescricao.getText().equals(""))
            vmCondicao_Consulta = " where custo_descricao like '" + txtDescricao.getText() + "%' order by custo_codigo_id";
        else
            vmCondicao_Consulta = " order by custo_codigo_id";
    ...
    private void initComponents() {
        ...
        setTitle("  (FpesqCentroCusto) - Pesquisa Centro de Custos");
        setResizable(false);
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtDescricao, javax.swing.GroupLayout.DEFAULT_SIZE, 471, Short.MAX_VALUE)
                .addGap(18, 18, 18)
