 ...
 * @author Thiago
 */
public class FpesqUnidadeMedida extends javax.swing.JDialog {
    ...
    public FpesqUnidadeMedida(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void MontaTituloColunaGrid()
    {
        grDados.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {},
            new String [] {"Código ","Descrição","UM",""
        ...
        grDados.getColumnModel().getColumn(1).setPreferredWidth(280);
    ...
    public void MontaGridCodigo()
    {
        ...
        if (!txtCodigo.getText().equals(""))
            vmCondicao_Consulta = " where unid_codigo_id = " + txtCodigo.getText() + " order by unid_codigo_id";
        else
            vmCondicao_Consulta = " order by unid_codigo_id";
        ...
        while (rs.next())
        {
            dtm.addRow(new Object[]{rs.getString("unid_codigo_id"),rs.getString("unid_descricao"),rs.getString("unid_unidade"),""});
        }
        rs.close();
    ...
    public void MontaGridDescricao()
    {
        ...
        if (!txtDescricao.getText().equals(""))
            vmCondicao_Consulta = " where unid_descricao like '" + txtDescricao.getText() + "%' order by unid_codigo_id";
        else
            vmCondicao_Consulta = " order by unid_codigo_id";
    ...
    private void initComponents() {
        ...
        setTitle("Pesquisa Unidade de Medida");
        setResizable(false);
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtDescricao, javax.swing.GroupLayout.DEFAULT_SIZE, 385, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jToolBar1, javax.swing.GroupLayout.DEFAULT_SIZE, 465, Short.MAX_VALUE)
