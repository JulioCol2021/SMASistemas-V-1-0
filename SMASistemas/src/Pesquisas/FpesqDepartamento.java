 ...
 * @author Thiago
 */
public class FpesqDepartamento extends javax.swing.JDialog {
    ...
    public FpesqDepartamento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void MontaGridCodigo()
    {
        ...
        if (!txtCodigo.getText().equals(""))
            vmCondicao_Consulta = " where depa_codigo_id = " + txtCodigo.getText() + " order by depa_codigo_id";
        else
            vmCondicao_Consulta = " order by depa_codigo_id";
        ...
        while (rs.next())
        {
            dtm.addRow(new Object[]{rs.getString("DEPA_CODIGO_ID"),rs.getString("DEPA_DESCRICAO"),""});
        }
        rs.close();
    ...
    public void MontaGridDescricao()
    {
        ...
        if (!txtDescricao.getText().equals(""))
            vmCondicao_Consulta = " where depa_descricao like '" + txtDescricao.getText() + "%' order by depa_codigo_id";
        else
            vmCondicao_Consulta = " order by depa_codigo_id";
    ...
    private void initComponents() {
        ...
        setTitle("  (FpesqDepartamento) - Pesquisa Departamentos");
        setResizable(false);
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtDescricao, javax.swing.GroupLayout.DEFAULT_SIZE, 376, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
