 ...
 * @author Thiago
 */
public class FpesqGrupos extends javax.swing.JDialog {
    ...
    public FpesqGrupos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void MontaTituloColunaGrid()
    {
        grDados.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {},
            new String [] {"Código ","Descrição","Tipo",""
        ...
        grDados.getColumnModel().getColumn(1).setPreferredWidth(200);
        grDados.getColumnModel().getColumn(2).setPreferredWidth(100);
   ...
   public void MontaGridCodigo()
    {
        ...
        if (!txtCodigo.getText().equals(""))
            vmCondicao_Consulta = " where grup_codigo_id = " + txtCodigo.getText() + " and grup_tipo like  '" + variaveis.tipo_grupo + "%' order by grup_codigo_id";
        else
            vmCondicao_Consulta = " where  grup_tipo like '" + variaveis.tipo_grupo + "%' order by grup_codigo_id";
        ...
        while (rs.next())
        {
            dtm.addRow(new Object[]{rs.getString("grup_codigo_id"),rs.getString("grup_descricao"),rs.getString("grup_tipo"),""});
        }
        rs.close();
    ...
    public void MontaGridDescricao()
    {
        ...
        if (!txtDescricao.getText().equals(""))
            vmCondicao_Consulta = " where grup_descricao like '" + txtDescricao.getText() + "%' and grup_tipo like '" + variaveis.tipo_grupo +"%' order by grup_codigo_id";
        else
            vmCondicao_Consulta = " where grup_tipo like '" + variaveis.tipo_grupo + "%' order by grup_codigo_id";
    ...
    private void initComponents() {
        ...
        btnPesquisaCodigo.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
